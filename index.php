...
<head>
    ...
    <!-- Add this in your <head> to include Bootstrap Icons -->
    ...
    <style>
        ...
        /* Ensures uniform card heights and aligned buttons */
        .row.g-4 {
            display: flex;
            flex-wrap: wrap;
        }
...
<body>
        ...
        <div class="container max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="collapse navbar-collapse justify-content-end" id="navbarNav">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item">
                        <a class="nav-link fw-semibold d-flex align-items-center" href="login.php">
    ...
    <section class="hero-bg d-flex flex-column justify-content-center text-center px-4"
        ...
        <div class="container position-relative" style="z-index: 1; max-width: 900px;">
            ...
            <div class="row text-center mt-5 text-white mx-auto" style="max-width: 700px;">
                ...
                <div class="col-12 col-sm-4 mb-4">
                    <div class="stats-number" data-target="25000">0</div>
        ...
        <svg viewBox="0 0 1440 120" fill="none" xmlns="http://www.w3.org/2000/svg"
            class="position-absolute  start-0 end-0" style="z-index:1;bottom: 0px;">
            <path
    ...
    <section class="py-5 bg-white">
        <div class="container max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center mb-5">
                <h2 class="text-4xl fw-bold text-gray-900 mb-3">Find Your Perfect House</h2>
                <p class="text-xl text-secondary mx-auto" style="max-width:600px;">
                    Browse different types of houses available for rent in your area
                </p>
            </div>
            <div class="row g-4">
                <!-- Example house cards -->
                <div class="col-12 col-sm-6 col-lg-3">
                    <div class="card h-100 shadow-sm">
                        ...
                        <div class="card-body">
                            ...
                            <p class="card-text text-muted mb-1"><small>Location: Goa, India</small></p>
                            <p class="fw-bold text-danger mb-2">$80,000 / month</p>
                            <ul class="list-unstyled mb-2">
                                <li>4 BHK | 3200 sq ft</li>
                                <li>Swimming Pool, Garden, Garage</li>
                            </ul>
                            <a href="view_details.php?house=modern-villa"
                                class="btn btn-gradient w-100 text-white rounded-pill"
                                style="background: linear-gradient(to right, #2563eb, #7c3aed);">
                                View Details
                            </a>
                        </div>
                ...
                <div class="col-12 col-sm-6 col-lg-3">
                    <div class="card h-100 shadow-sm">
                        ...
                        <div class="card-body">
                            ...
                            <p class="card-text text-muted mb-1"><small>Location: Mumbai, India</small></p>
                            <p class="fw-bold text-danger mb-2">$38,000 / month</p>
                            <ul class="list-unstyled mb-2">
                                <li>2 BHK | 1200 sq ft</li>
                                <li>Parking, Gym, Security</li>
                            </ul>
                            <a href="view_details.php?house=city-apartment"
                                class="btn btn-gradient w-100 text-white rounded-pill"
                                style="background: linear-gradient(to right, #2563eb, #7c3aed);">
                                View Details
                            </a>
                ...
                <div class="col-12 col-sm-6 col-lg-3">
                    <div class="card h-100 shadow-sm">
                        <img src="https://images.unsplash.com/photo-1507089947368-19c1da9775ae?auto=format&fit=crop&w=500&q=80"
                            class="card-img-top" alt="Family Home" />
                        <div class="card-body">
                            <h5 class="card-title">Beach Cottage</h5>
                            <p class="card-text text-muted mb-1"><small>Location: Kerala, India</small></p>
                            <p class="fw-bold text-danger mb-2">$45,000 / month</p>
                            <ul class="list-unstyled mb-2">
                                <li>3 BHK | 1500 sq ft</li>
                                <li>Sea View, Pet Friendly, Garden</li>
                            </ul>
                            <a href="view_details.php?house=beach-cottage"
                                class="btn btn-gradient w-100 text-white rounded-pill"
                                style="background: linear-gradient(to right, #2563eb, #7c3aed);">
                                View Details
                            </a>
                ...
                <div class="col-12 col-sm-6 col-lg-3">
                    <div class="card h-100 shadow-sm">
                        ...
                        <div class="card-body">
                            ...
                            <p class="card-text text-muted mb-1"><small>Location: Pune, India</small></p>
                            <p class="fw-bold text-danger mb-2">$58,000 / month</p>
                            <ul class="list-unstyled mb-2">
                                <li>3 BHK | 1900 sq ft</li>
                                <li>Garage, Garden, School Nearby</li>
                            </ul>
                            <a href="view_details.php?house=family-home"
                                class="btn btn-gradient w-100 text-white rounded-pill"
                                style="background: linear-gradient(to right, #2563eb, #7c3aed);">
                                View Details
                            </a>
    ...
    <footer class="py-4 bg-light text-dark text-center">
    ...
    <!-- <footer class="py-5 bg-dark text-light">
        <div class="container max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="d-flex flex-column flex-sm-row justify-content-between align-items-center">
                <p class="text-secondary mb-3 mb-sm-0">&copy; 2025 SpaceRent. All rights reserved.</p>
    ...
    <script>
        $(document).ready(function () {
            $.ajax({
                url: "api/get_spaces.php",
                type: "GET",
                dataType: "json",
                success: function (response) {
                    let container = $(".row.g-4");
                    container.empty();
                    ...
                    if (response.status === "success") {
                        ...
                        <div class="col-12 col-sm-6 col-lg-4 d-flex">
                            <div class="card shadow-sm flex-fill h-100">
                                <img src="${space.image_url || 'https://via.placeholder.com/500'}" 
                                     class="card-img-top" alt="${space.space_title}" />
                                <div class="card-body d-flex flex-column justify-content-between">
                                    <div>
                                        <h5 class="card-title">${space.space_title}</h5>
                                        <p class="fw-bold text-danger mb-2">$${space.price_day} / day</p>
                                        <ul class="list-unstyled mb-2">
                                            <li>${space.size} | ${space.total_persons} persons</li>
                                            <li>${space.amenities || 'No amenities listed'}</li>
                                        </ul>
                                    </div>
                                    <a href="view_details.php?id=${space.id}"
                                       class="btn btn-gradient w-100 text-white rounded-pill mt-auto">
                                       View Details
                                    </a>
                                </div>
                            </div>
                        ...
                        container.html("<p class='text-center text-muted'>No spaces available.</p>");
                    }
                },
                error: function (xhr, status, error) {
                    console.log(error);
                    $(".row.g-4").html("<p class='text-center text-danger'>Error loading data.</p>");
                }
            });
        });
    </script>
